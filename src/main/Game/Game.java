...
public class Game {
    ...
    public void init() {
        ...
        Zone petanque = new Zone("La petanque",
                "Un petit espace graviollonné parfait pour partager un pastis en jouant une partie de boules.", true);
        ...
        Zone trouNoir = new Zone("Le trou noir",
                "La légende dit que personne n'est jamais resortie de cette zone. A vos risques et perils.", true);
